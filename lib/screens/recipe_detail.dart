        ...
        actions: <Widget>[
          IconButton(
              ...
              onPressed: () {
                ...
                final recipeDownload = DownloadRecipe(
                  id: 1,
                  title: _loadedRecipe.title,
                  imageUri: _loadedRecipe.imageUrl,
                  calories: _loadedRecipe.calories,
                  duration: _loadedRecipe.duration,
                  difficulty: _loadedRecipe.difficulty,
                  method: _loadedRecipe.method,
                  preparation: _loadedRecipe.preparation,
                  ingredients: _loadedRecipe
                      .ingredients[_recipeNotifier.activeServe]
                      .toString(),
                );

                print('Insert? ${_loadedRecipe.title}');

                database.insertDownloadRecipe(recipeDownload);
...
class _DownloadedRecipeDetailScreenState extends State<RecipeDetailScreen> {
  void fitchActiveServe() {
    Future.delayed(Duration(seconds: 0)).then((_) async {
      Provider.of<AllRecipeNotifier>(context).activeServe = 0;
    });
